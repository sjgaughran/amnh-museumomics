...
Welcome to the museum genomics workshop at SCCS-NY, hosted by the Center for Biodiversity and Conservation at the American Museum of Natural History! This short workshop provides an introduction to using museum collections for conservation-related genomics work. We cover background of the field, offer breakout group discussions with organizers about project ideas and designs, and provide a brief hands-on data analysis example using a publicly available genomics data set. 
